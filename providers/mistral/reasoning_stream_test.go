...
func TestCompletionStreamPreservesThinkingChunks(t *testing.T) {
	...
	require.NotNil(t, chunks[3].Choices[0].Delta.Reasoning)
	require.JSONEq(t, `[
		{"type":"thinking","thinking":[
			{"type":"text","text":"step one","reference_ids":[{}]},
			{"type":"reference","reference_ids":[1,1e2,999999999999999999999999,"ref-1"],"text":{}}
		...
		{"type":"future_chunk","text":{},"future":true},
		{"type":"thinking","thinking":[{"type":"text","text":"step two"}],"signature":"sig-2","closed":true},
		{"type":"text","text":"the "},
		{"type":"text","text":"answer"}
	]`, string(chunks[3].Choices[0].Delta.Reasoning.ProviderRaw))
	...
	_, err = replayProvider.Completion(t.Context(), providers.CompletionParams{
		...
		Messages: []providers.Message{{
			...
			Content:   transition.Content + chunks[2].Choices[0].Delta.Content,
			Reasoning: chunks[3].Choices[0].Delta.Reasoning,
		}},
	})
	require.NoError(t, err)
	require.JSONEq(
